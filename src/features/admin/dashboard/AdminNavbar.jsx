...
export const AdminNavbar = ({ logout, children }) => {
    return (
        <header className="fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800 shadow-sm transition-all">
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <Link to="/admin" className="flex items-center gap-2 hover:opacity-80 transition-opacity cursor-pointer">
                        ...
                        <h1 className="text-2xl font-black tracking-tight text-white">
                            Salud<span className="text-blue-500">Admin</span>
                        </h1>
                    </Link>
                    ...
                    <div className="flex items-center gap-6">
                        <button
                            onClick={logout}
                            className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-400 hover:text-rose-500 transition-colors"
                        >
